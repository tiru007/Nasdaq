# https://analyzingalpha.com/nasdaq-data-link-quandl-python-api
...
tickers = df.query('category == "Domestic Common Stock"')
tickers = tickers.reset_index()

for ticker in tickers['ticker']:
    print(ticker)
columns = ['Domestic Common Stock', 'Domestic Common Stock Secondary Class', 'Domestic Preferred Stock', 'ADR Common Stock', 'Domestic Common Stock Primary Class', 'Canadian Common Stock', 'ADR Common Stock Primary Class', 'Canadian Common Stock Primary Class', 'ADR Preferred Stock', 'Canadian Preferred Stock', 'ADR Common Stock Secondary Class', 'Canadian Common Stock Secondary Class']
symbols = df[df.category.isin(columns)]
symbols = symbols[symbols.active]